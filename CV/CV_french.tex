...
\begin{rSection}{Bourses et distinctions}	
	\textbf{CRSNG} — Bourse d’études supérieures Maîtrise \textbf{(27 000 \$)} \hfill 2025-2026 \\
	\vspace{-2ex}\\
...
\begin{rSection}{Enseignement et expérience de recherche}
	...
	\begin{rSubsection}{UBC Faculty of Forestry}{2024-Present}{Graduate Teacher Assistant}{University of British Columbia, Canada}
		\item  FRST-304 Forest stewardship in a changing climate, enseigné par Dr. Suzanne Simard pour 1217 students (2025)
		\item  FRST-303 Principles of Forest Sciences enseigné par Dr. Sally Aitken pour 1962 students (2024) 
	\end{rSubsection}
%------------------------------------------------
	\begin{rSubsection}{Temporal Ecology Lab}{2023-2024}{USRA Undergraduate Researcher}{University of British Columbia, Canada}
		\item Coordination d’un projet de recherche en environnement controlé sur les réponses phénologiques et la croissance des arbres face à des saisons croissance plus longues (2024)
		\item Participation à un projet de recherche sur les réponses phénologiques de différentes espèces d’arbres aux sécheresses et à la défoliation (2023)
	\end{rSubsection}
%------------------------------------------------
...
\begin{rSection}{VULGARISATION SCIENTIFIQUE}
  \textbf{Tree Spotters — Groupe de science citoyenne} — \textit{Arnold Arboretum, Harvard University} \hfill 2025 \\
