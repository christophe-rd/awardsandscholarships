...
\begin{rSection}{Bourses}	
	\textbf{Bourse d’études supérieures du CRSNG — Maîtrise} (27 000 \$) \hfill 2025 \\
	\vspace{-2ex}\\
	\textbf{Bourse Cocodet en sciences} (21 375 \$) \hfill 2023-2024 \\
	\vspace{-2ex}\\
	\textbf{Bourses de recherche de 1er cycle du CRSNG} (6 000 \$) \hfill 2022-2023-2024 \\ 
	\vspace{-2ex}\\
	\textbf{Supplément de la Bourse de recherche de 1er cycle du FRQNT} (1 500 \$) \hfill 2022-2023-2024\\ 
	\vspace{-2ex}\\
	\textbf{Liste d’excellence du doyen de la Faculté des sciences de l’UQAM}  \hfill 2023 \\ 
	\vspace{-2ex}\\
	\textbf{Supplément à l’appui de la diversité de l’effectif dans le secteur forestier canadien du CRSNG} (5 000 \$) \hfill 2023 \\ 
	\vspace{-2ex}\\
	\textbf{Bourse Jeanne-D’Arc et Bertin-Trottier en sciences} (1 500 \$) \hfill 2023 \\ 
	\vspace{-2ex}\\
	\textbf{Bourse du Syndicat des professeurs de l’UQÀM} (1 500 \$) \hfill 2023 \\ 
	\vspace{-2ex}\\
	\textbf{Bourse de la Fondation Familiale Trottier} (1 500 \$) \hfill 2022 \\ 
	\vspace{-2ex}\\
	\textbf{Bourse de la Banque TD} (2 000 \$) \hfill 2022 \\ 
\end{rSection}
...
%------------------------------------------------
	...
	\begin{rSubsection}{Laboratoire des cascades écologiques}{2022}{Assistant de recherche au 1er cycle}{University of Queensland, Australie}
		\item Participation à un projet de recherche à distance dans les forêts humides des tropiques australiens sur les interactions entre espèces
	\end{rSubsection}
\end{rSection}
...
\begin{rSection}{Bénévolat et tutorat}
	\begin{rSubsection}{BUDR}{2025}{Bénévole}{Université de la Colombie-Britannique}
		\item Accompagnement de deux étudiant·e·s de premier cycle dans la poursuite de leurs objectifs de recherche
	\end{rSubsection}

	\begin{rSubsection}{Faculté des sciences de l’UQAM}{2023-2024}{Tuteur}{Université du Québec à Montréal, Canada}
		\item Soutien à sept étudiant·e·s de première année dans leur cours de biochimie
	\end{rSubsection}
